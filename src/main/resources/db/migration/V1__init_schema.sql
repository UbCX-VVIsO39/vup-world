-- ============================================================
-- Flyway V1: 初始数据库 Schema
-- 30天VUP出道经营游戏的全部建表语句（user_account / vup / save_slot /
-- day_session / business_log / daily_report / ending_review / risk_debt /
-- game_content / game_unlock / game_stats_history / p0_seed_manifest 等）
-- 从原 schema.sql 迁移而来，由 Flyway 接管执行。
-- H2 在 MODE=MySQL 下可正常执行本脚本（与原 spring.sql.init 行为一致）。
-- ============================================================
